...
function generarDiploma($id, $db, $output = 'I') {
    ...
    <p style="text-align:center;">
        ...
        <p style="line-height: 1pt;font-size: 30px;font-family: crimson;text-align: center;"><?php echo mb_strtoupper(fixEncode($carreraData['nombre'], true, true));?></p>
...
function generarActaExamenLicenciatura($id, $db, $output = 'I') {
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td width="13%" valign="top" align="center" style="padding-top:15px;"><img width="86" src="<?php echo getLogo('gobernacion'); ?>" /></td>
